export const testimonials = [
  {
    name: "Ahmed R.",
    location: "Bought a plot in Bahria Town, from the UK",
    quote:
  ...
  {
    name: "Bilal H.",
    location: "Bought a house in Gulberg Residencia",
    quote:
      "The installment plan they arranged actually matched what was promised at signing — no hidden changes halfway through. That alone made it worth going with them.",
  },
  {
    name: "Fatima K.",
    location: "Bought a plot in Capital Smart City, from Dubai",
    quote:
      "Being overseas, I was nervous about fraud. Meridian verified the NOC status before I even asked and kept me updated at every step of the transfer.",
  },
  {
    name: "Usman T.",
    location: "Bought a house in DHA Phase 2",
    quote:
